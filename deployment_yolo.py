...
input_dir = r"C:/Users/User/Documents/tritons_dataset/Triton_dataset_new/train"  #папка с изображением, которое ищем
output_dir = r"C:/Users/User/Documents/Triton_dataset_new/crop_dataset"  #путь сохранения обрезанных фотографий (то же самое в модели vit)
