...
async def unwrap_belly_trimmed_ends(image, mask, pt1=None, pt2=None, save_path="unwrapped.jpg", debug_path="debug_centerline.jpg",
...
async def process_single_image(img_path, output_dir, species_name="unknown", individual_name="unknown"):
    ...
    try:
        ...
        await unwrap_belly_trimmed_ends(image, mask, pt1, pt2, save_path, debug_path)
